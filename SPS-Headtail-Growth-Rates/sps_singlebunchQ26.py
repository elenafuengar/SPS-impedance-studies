...
def run(qpv_val, n_slices, n_mp):
    ...
    n_turns_wake = 1  #number of turns the wakefield is alive
    wakefile1 = ('Q26.wake')            # complete impedance model 2023
    ...
    r_h_dip = Resonator(R_shunt=2.e7, frequency=2.5e9, Q=100., Yokoya_X1=1., Yokoya_Y1=0., Yokoya_X2=0., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_h_quad = Resonator(R_shunt=2.7*1.0, frequency=2.5e9, Q=100., Yokoya_X1=0., Yokoya_Y1=0., Yokoya_X2=-1., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_v_dip = Resonator(R_shunt=2.e7, frequency=2.5e9, Q=100., Yokoya_X1=0., Yokoya_Y1=1., Yokoya_X2=0., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_v_quad = Resonator(R_shunt=2.e7*1.0, frequency=2.5e9, Q=100., Yokoya_X1=0., Yokoya_Y1=0., Yokoya_X2=0., Yokoya_Y2=1., switch_Z=False, n_turns_wake=n_turns_wake)
    ...
    bunchmonitor = BunchMonitor(
         f'./bunchmonitor_qpv{qpv}_nonlinearq26', n_turns,
    ...
    activated_particlemonitor = True
