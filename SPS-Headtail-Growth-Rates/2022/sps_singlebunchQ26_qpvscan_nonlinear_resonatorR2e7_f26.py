...
def run(qpv_val, n_slices, n_mp):
    ...
    n_turns_wake = 1  #number of turns the wakefield is alive. In single bunch crashes
    wakefile1 = ('/afs/cern.ch/user/e/edelafue/growthrate/pyheadtail/Q26.wake')
    ...
    r_h_dip = Resonator(R_shunt=2.e7, frequency=2.6e9, Q=100., Yokoya_X1=1., Yokoya_Y1=0., Yokoya_X2=0., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_h_quad = Resonator(R_shunt=2.e7*1.0, frequency=2.6e9, Q=100., Yokoya_X1=0., Yokoya_Y1=0., Yokoya_X2=-1., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_v_dip = Resonator(R_shunt=2.e7, frequency=2.6e9, Q=100., Yokoya_X1=0., Yokoya_Y1=1., Yokoya_X2=0., Yokoya_Y2=0., switch_Z=False, n_turns_wake=n_turns_wake)
    r_v_quad = Resonator(R_shunt=2.e7*1.0, frequency=2.6e9, Q=100., Yokoya_X1=0., Yokoya_Y1=0., Yokoya_X2=0., Yokoya_Y2=1., switch_Z=False, n_turns_wake=n_turns_wake)
    ...
    bunchmonitor = BunchMonitor(
         f'./bunchmonitor_qpv{qpv}_nonlinearq26_resonatorR2e7_f26', n_turns,
...
if __name__=="__main__":
    ...
    qpv_vect = [0, -0.05, -0.1, -0.15, -0.2, -0.25, -0.3, -0.35,
